...
2. Prompt you to set `GATEWAY_PASSWORD`
...
The web dashboard is available at `https://<your-service>.onrender.com/moltbot`. Log in using your `GATEWAY_PASSWORD`.
...
Export your configuration and workspace at any time via the Control UI or CLI.
...
- Missing `GATEWAY_PASSWORD` — the Blueprint prompts for this, but verify it's set
