...
INSERT INTO products (ref, name, description, price_brl, permissions, access_url, category) VALUES
  ('smart-factory-basic', 'Smart Factory Basic', 'Mint tokens + Dashboard access', 99.90, 
   '["member", "dashboard", "api:mint"]', 
   'https://smart-ui-delta.vercel.app/members/dashboard',
   'tokenization'),
   
  ('smart-factory-pro', 'Smart Factory Pro', 'Full tokenization suite + Support', 299.90,
   '["member", "dashboard", "api:mint", "api:verify", "api:bridge", "support"]',
   'https://smart-ui-delta.vercel.app/members/pro',
   'tokenization'),
   
  ('wod-pro-membership', 'WOD [X] PRO Membership', 'Arena access + Validator badge', 49.90,
   '["member", "arena", "validator"]',
   'https://wodxpro.com/arena',
   'fitness'),
   
  ('fluxx-dao-stake', 'FLUXX DAO Stake', 'Governance rights + Treasury view', 199.00,
   '["member", "governance", "treasury:view"]',
   'https://fluxx-dao.vercel.app/governance',
   'dao');
