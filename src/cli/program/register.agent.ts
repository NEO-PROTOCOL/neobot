...
${formatHelpExamples([
  ['openclaw agent --to +5562983231110 --message "status update"', "Start a new session."],
  ...
  [
    'openclaw agent --to +5562983231110 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['openclaw agent --to +5562983231110 --message "Summon reply" --deliver', "Deliver reply."],
  [
