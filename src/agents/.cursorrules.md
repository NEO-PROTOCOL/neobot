...
- NODE NEØ.run (ARCHIVED - replaced by content-machine local)
...
- `NEO-PROTOCOL/neobot` (this repo - OpenClaw fork)
  - Location: `/Users/nettomello/CODIGOS/neobot/`

### 🟢 Lead Qualification (PRODUCTION ✅)

- `NEO-FlowOFF/flowcloser-agent`
...
### 🏭 Tokenization (org: neo-smart-factory)
...
- `NEO-FlowOFF/neoflowoff-nodemello.run`
...
┃ WOD [X] PRO       [###-]   MEDIUM ⚡
┃ FLUXX DAO         [###-]   MEDIUM ⚡
┃ AGENT-FULL        [####]   PRODUCTION ✅
┃ Evolution API     [----]   ARCHIVED 🔴
┃ CEO Escalável     [####]   PRODUCTION ✅
┃ NODE NEØ.run      [XXXX]   ARCHIVED 🔴
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
- ❌ Use NODE NEØ.run (it's archived!)
...
**Version:** 2.1 (Organization Migration to NEO-PROTOCOL)
**Status:** ACTIVE - Organization Migration Completed
